...
private class TrackingSpanProcessor : SpanProcessor {
    ...
    override fun onStart(parentContext: Context, span: ReadWriteSpan) { active += span.spanContext.spanId }
    override fun isStartRequired() = true
    override fun onEnd(span: ReadableSpan) { active -= span.spanContext.spanId }
