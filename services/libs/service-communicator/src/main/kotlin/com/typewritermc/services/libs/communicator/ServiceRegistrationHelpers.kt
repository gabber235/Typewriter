...
suspend fun NatsClient.queryServiceStatus(serviceId: String): ServiceStatusResult {
    ...
    val response = try {
        request(subject, requestBytes, timeoutMs = 10.seconds.inWholeMilliseconds)
    } catch (e: Exception) {
...
suspend fun NatsClient.subscribeToBoundNotification(
    serviceId: String,
