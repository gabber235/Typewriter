...
data class TagRecord(
    ...
    val parents: List<TagRecord> = emptyList()
) {
    companion object {
...
data class BookRecord(
    ...
    fun toBook(): Book {
        return Book {
            this.id = this@BookRecord.id.id.string
            this.title = this@BookRecord.title
            this.icon = this@BookRecord.icon
            this.color = Color { value = this@BookRecord.color.toUInt() }
            this.tags = this@BookRecord.tags.map { it.toTag() }
        }
    }
}
...
data class PageRecord(
    ...
    fun toPage(): Page {
        return Page {
            id = this@PageRecord.id.id.string
