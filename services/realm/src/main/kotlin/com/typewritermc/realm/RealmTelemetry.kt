...
private fun realmSampler(): Sampler = when (realmSetting("OTEL_TRACES_SAMPLER") ?: "always_on") {
...
private fun realmSamplerRatio(): Double =
    realmSetting("OTEL_TRACES_SAMPLER_ARG")?.toDoubleOrNull()?.coerceIn(0.0, 1.0) ?: 1.0

internal fun realmSetting(name: String, default: String? = null): String? =
