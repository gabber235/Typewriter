...
4. Verify that you **don't** have the [InteractiveChat](https://www.spigotmc.org/resources/interactivechat-show-items-inventory-in-chat-custom-chat-keywords-bungee-velocity-support.75870/) or [CustomNamePlates](https://polymart.org/resource/customnameplates.2543) plugin installed, as it may cause conflicts with Typewriter.
