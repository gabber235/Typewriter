...
## Quest Items
A key or a relic the player has to carry for a quest should not end up in a chest or in lava. Read
[Quest Items](./05-quest-items.mdx) for the audience that hands out an item the player cannot lose.
