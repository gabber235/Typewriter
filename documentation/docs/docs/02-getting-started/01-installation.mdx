...
Typewriter only works on **paper** and **folia** servers. It will not work on Spigot or Bukkit servers.
:::

## Installing the Typewriter Plugin

Ensure a smooth installation process for the Typewriter plugin on your Paper or Folia Minecraft server by following these steps:
