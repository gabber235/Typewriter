...
export default function StatusEditor({
  ...
  const statusConfig = {
    inactive: {
      ...
      label: "Inactive",
      description:
        "Quest is not yet started or is unavailable. Players won't see this quest in their log until the active criteria is met.",
      details: [
        "Not visible in quest log",
    ...
    active: {
      ...
      label: "Active",
      description:
        "Quest is currently active and in progress. Players can see and interact with this quest.",
      details: [
        "Visible in quest log",
        "Players can track progress",
        "Objectives are displayed",
        "Can trigger related events",
      ],
    },
    completed: {
      ...
      label: "Completed",
      description:
        "Quest has been completed. Players will see this quest marked as finished.",
      details: [
        "Marked as complete in log",
        "Can trigger completion rewards",
        "May unlock follow-up quests",
  ...
  const getFact = (val: number): string => {
    if (val <= 0) return "Permanent Fact = 0 (Inactive)";
    if (val === 5) return "Permanent Fact = 5 (Complete)";
    ...
    <div className={clsx("w-full my-4", className)}>
      <div className="flex flex-col items-stretch gap-3">
        ...
        >
          <div
            className={clsx(
              "flex-grow border rounded-md p-4 transition-all duration-300 flex flex-col h-[425px]",
              "hover:shadow-md",
              "ring-1",
              config.bg,
              config.ring,
