---
title: Typewriter
description: Build interactive quests, NPC dialogues, and cinematic sequences on your Paper Minecraft server — no coding required, endlessly extensible for developers.
template: splash
