---
title: Home
description: Typewriter is a free Paper plugin plus a web panel for building NPC dialogues, quests, scenes and living NPCs without code, and for extending them in Kotlin.
template: splash
...
import { Tile, Tiles } from '@components/landing/editor';
...
<Section
  ...
  lead="Drop the plugin into plugins/ next to PacketEvents and start the server. Players need nothing, the panel needs nothing installed."
  band
>
...
:::details[Do I have to host the panel myself?]{name=faq}
...
:::details[Where do I get help?]{name=faq}
Questions get answered on the [Discord](:var[discord]); bugs and feature requests go to [GitHub issues](:var[issues]).
:::
