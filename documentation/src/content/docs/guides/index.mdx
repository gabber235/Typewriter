...
<Aside type="security">Always validate user input to prevent injection attacks.</Aside>
...
<Aside type="quote">"Any sufficiently advanced technology is indistinguishable from magic." — Arthur C. Clarke</Aside>
