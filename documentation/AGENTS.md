...
- Categories are defined in `src/categories.ts`; `src/route-middleware.ts` (Starlight `routeMiddleware`) scopes the autogenerated sidebar and prev/next pagination to the current category
