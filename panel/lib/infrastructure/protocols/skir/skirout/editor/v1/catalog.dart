...
final class RealmActionDefinition implements RealmActionDefinition_orMutable {
  ...
  /// Returns a new mutable instance.
  /// Fields are initialized to their default values.
  static RealmActionDefinition_mutable mutable() =>
...
final class RealmActionDefinition_mutable
    implements RealmActionDefinition_orMutable {
...
sealed class CatalogFetchRequest_orMutable {
  ...
  get conversionIds;
  _core.Iterable<_lib_editor_v1_type_catalog.RealmActionId_orMutable>
  get realmActionIds;
...
final class CatalogFetchRequest implements CatalogFetchRequest_orMutable {
  ...
  @_core.override
  final _core.Iterable<_lib_editor_v1_type_catalog.RealmActionId>
  realmActionIds;
  @_core.override
  ...
  factory CatalogFetchRequest({
    ...
    conversionIds,
    required _core.Iterable<_lib_editor_v1_type_catalog.RealmActionId_orMutable>
    realmActionIds,
  ...
  get serializer {
    if (_serializerBuilder.mustInitialize()) {
      _serializerBuilder.addField(
        ...
        "expectedGeneration",
        0,
        _skir.Serializers.optional(CatalogGeneration.serializer),
        "",
...
final class CatalogFetchRequest_mutable
  ...
  _core.List<_lib_editor_v1_type_catalog.RealmActionId_orMutable>
  get mutableRealmActionIds {
    final value = this.realmActionIds;
    if (value
        is _skir.internal__MutableList<
          _lib_editor_v1_type_catalog.RealmActionId_orMutable
        >) {
      return value;
    } else {
...
final class CatalogFetchSuccess implements CatalogFetchSuccess_orMutable {
  ...
  factory CatalogFetchSuccess({
    ...
    >
    conversions,
    required _core.Iterable<RealmActionDefinition_orMutable>
  ...
  get serializer {
    if (_serializerBuilder.mustInitialize()) {
      ...
      _serializerBuilder.addField(
        ...
        "realmActionDefinitions",
        4,
        _skir.Serializers.iterable(RealmActionDefinition.serializer),
        "",
...
final class CatalogFetchSuccess_mutable
  ...
  _core.List<RealmActionDefinition_orMutable>
  get mutableRealmActionDefinitions {
    final value = this.realmActionDefinitions;
    if (value is _skir.internal__MutableList<RealmActionDefinition_orMutable>) {
      return value;
    } else {
      return this.realmActionDefinitions = _skir.internal__MutableList([
        ...value,
      ]);
    }
  }
...
final class CatalogGenerationMismatch
  ...
  static CatalogGenerationMismatch_mutable mutable() =>
      CatalogGenerationMismatch_mutable._(CatalogGeneration.defaultInstance);
...
final class CatalogInvalidated implements CatalogInvalidated_orMutable {
  ...
  /// Returns a new mutable instance.
  /// Fields are initialized to their default values.
  static CatalogInvalidated_mutable mutable() =>
      CatalogInvalidated_mutable._(CatalogGeneration.defaultInstance, "");
...
sealed class CatalogWatchUpdate {
  ...
  factory CatalogWatchUpdate.wrapInitial(CatalogGeneration value) =>
  ...
  factory CatalogWatchUpdate.createInitial({required _core.String value}) =>
      CatalogWatchUpdate.wrapInitial(CatalogGeneration(value: value));
