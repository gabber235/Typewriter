...
mixin _$MenuItem implements DiagnosticableTreeMixin {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    properties..add(DiagnosticsProperty('type', 'MenuItem'));
  }

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is MenuItem);
  }
...
class MenuItemSubmenu with DiagnosticableTreeMixin implements MenuItem {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $MenuItemSubmenuCopyWith<MenuItemSubmenu> get copyWith =>
      _$MenuItemSubmenuCopyWithImpl<MenuItemSubmenu>(this, _$identity);
  ...
  int get hashCode => Object.hash(runtimeType, label,
      const DeepCollectionEquality().hash(_items), icon, color);
...
/// @nodoc
abstract mixin class $MenuItemSubmenuCopyWith<$Res>
    implements $MenuItemCopyWith<$Res> {
  factory $MenuItemSubmenuCopyWith(
          MenuItemSubmenu value, $Res Function(MenuItemSubmenu) _then) =
      _$MenuItemSubmenuCopyWithImpl;
  @useResult
  $Res call({String label, List<MenuItem> items, Widget? icon, Color? color});
}
...
class MenuItemDivider with DiagnosticableTreeMixin implements MenuItem {
  ...
  @override
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    properties..add(DiagnosticsProperty('type', 'MenuItem.divider'));
  }

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is MenuItemDivider);
  }
