...
final class ProposedModulesProvider
    extends
        $AsyncNotifierProvider<ProposedModules, List<ManualModuleReference>> {
...
final class ProposedModulesFamily extends $Family
  ...
  ProposedModulesProvider call(String manualId) =>
...
abstract class _$ProposedModules
  ...
  FutureOr<List<ManualModuleReference>> build(String manualId);
  @$mustCallSuper
  @override
  void runBuild() {
...
final class ProposedModulesIdsFamily extends $Family
  ...
  ProposedModulesIdsProvider call(String manualId) =>
...
abstract class _$ProposedModulesIds extends $AsyncNotifier<List<String>> {
  ...
  FutureOr<List<String>> build(String manualId);
  @$mustCallSuper
  @override
  void runBuild() {
    final created = build(_$args);
...
final class ManualModulesInfoProvider
    extends
        $FunctionalProvider<
  ...
  FutureOr<List<ManualModuleInformation>> create(Ref ref) {
    ...
    return manualModulesInfo(ref, argument);
  }
...
final class ManualModulesInfoFamily extends $Family
  ...
  ManualModulesInfoProvider call(String manualId) =>
