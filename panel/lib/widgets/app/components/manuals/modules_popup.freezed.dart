...
$ManualModuleInformationCopyWith<ManualModuleInformation> get copyWith => _$ManualModuleInformationCopyWithImpl<ManualModuleInformation>(this as ManualModuleInformation, _$identity);
...
void debugFillProperties(DiagnosticPropertiesBuilder properties) {
  properties
    ...
    ..add(DiagnosticsProperty('moduleId', moduleId))..add(DiagnosticsProperty('name', name))..add(DiagnosticsProperty('description', description))..add(DiagnosticsProperty('author', author))..add(DiagnosticsProperty('type', type))..add(DiagnosticsProperty('version', version))..add(DiagnosticsProperty('compatibleVersions', compatibleVersions))..add(DiagnosticsProperty('canBeRemoved', canBeRemoved));
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ManualModuleInformation&&(identical(other.moduleId, moduleId) || other.moduleId == moduleId)&&(identical(other.name, name) || other.name == name)&&(identical(other.description, description) || other.description == description)&&(identical(other.author, author) || other.author == author)&&(identical(other.type, type) || other.type == type)&&(identical(other.version, version) || other.version == version)&&const DeepCollectionEquality().equals(other.compatibleVersions, compatibleVersions)&&(identical(other.canBeRemoved, canBeRemoved) || other.canBeRemoved == canBeRemoved));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,moduleId,name,description,author,type,version,const DeepCollectionEquality().hash(compatibleVersions),canBeRemoved);
...
/// Create a copy of ManualModuleInformation
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? moduleId = null,Object? name = null,Object? description = null,Object? author = null,Object? type = null,Object? version = null,Object? compatibleVersions = null,Object? canBeRemoved = null,}) {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _ManualModuleInformation value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _ManualModuleInformation value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _ManualModuleInformation value)?  $default,){
final _that = this;
switch (_that) {
case _ManualModuleInformation() when $default != null:
return $default(_that);case _:
...
@override@JsonKey() final  bool canBeRemoved;

/// Create a copy of ManualModuleInformation
/// with the given fields replaced by the non-null parameter values.
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$ManualModuleInformationCopyWith<_ManualModuleInformation> get copyWith => __$ManualModuleInformationCopyWithImpl<_ManualModuleInformation>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$ManualModuleInformationToJson(this, );
}
@override
void debugFillProperties(DiagnosticPropertiesBuilder properties) {
  properties
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ManualModuleInformation&&(identical(other.moduleId, moduleId) || other.moduleId == moduleId)&&(identical(other.name, name) || other.name == name)&&(identical(other.description, description) || other.description == description)&&(identical(other.author, author) || other.author == author)&&(identical(other.type, type) || other.type == type)&&(identical(other.version, version) || other.version == version)&&const DeepCollectionEquality().equals(other._compatibleVersions, _compatibleVersions)&&(identical(other.canBeRemoved, canBeRemoved) || other.canBeRemoved == canBeRemoved));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,moduleId,name,description,author,type,version,const DeepCollectionEquality().hash(_compatibleVersions),canBeRemoved);
...
/// @nodoc
abstract mixin class _$ManualModuleInformationCopyWith<$Res> implements $ManualModuleInformationCopyWith<$Res> {
...
/// Create a copy of ManualModuleInformation
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? moduleId = null,Object? name = null,Object? description = null,Object? author = null,Object? type = null,Object? version = null,Object? compatibleVersions = null,Object? canBeRemoved = null,}) {
