...
mixin _$OrganizationData {
 ...
 String get name; String get id; String? get iconUrl;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is OrganizationData&&(identical(other.name, name) || other.name == name)&&(identical(other.id, id) || other.id == id)&&(identical(other.iconUrl, iconUrl) || other.iconUrl == iconUrl));
}
...
@useResult
$Res call({
 String name, String id, String? iconUrl
});
...
/// Create a copy of OrganizationData
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? name = null,Object? id = null,Object? iconUrl = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String name,  String id,  String? iconUrl)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _OrganizationData() when $default != null:
return $default(_that.name,_that.id,_that.iconUrl);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String name,  String id,  String? iconUrl)  $default,) {final _that = this;
switch (_that) {
case _OrganizationData():
return $default(_that.name,_that.id,_that.iconUrl);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String name,  String id,  String? iconUrl)?  $default,) {final _that = this;
switch (_that) {
case _OrganizationData() when $default != null:
return $default(_that.name,_that.id,_that.iconUrl);case _:
  return null;
...
class _OrganizationData implements OrganizationData {
  ...
  factory _OrganizationData.fromJson(Map<String, dynamic> json) => _$OrganizationDataFromJson(json);
...
@override
Map<String, dynamic> toJson() {
  return _$OrganizationDataToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _OrganizationData&&(identical(other.name, name) || other.name == name)&&(identical(other.id, id) || other.id == id)&&(identical(other.iconUrl, iconUrl) || other.iconUrl == iconUrl));
}
...
/// Create a copy of OrganizationData
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? name = null,Object? id = null,Object? iconUrl = freezed,}) {
