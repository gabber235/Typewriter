...
_Platform _$PlatformFromJson(Map<String, dynamic> json) => _Platform(
      ...
      requirements: (json['requirements'] as List<dynamic>?)
              ?.map((e) =>
                  PlatformRequirement.fromJson(e as Map<String, dynamic>))
              .toList() ??
          const [],
    );
...
PlatformVersionConstraint _$PlatformVersionConstraintFromJson(
    ...
    PlatformVersionConstraint(
      versions:
          const SemverListJsonConverter().fromJson(json['versions'] as List),
    );
...
_PlatformTarget _$PlatformTargetFromJson(Map<String, dynamic> json) =>
    _PlatformTarget(
      ...
      constraints: (json['constraints'] as Map<String, dynamic>?)?.map(
            (k, e) => MapEntry(
                k, PlatformConstraint.fromJson(e as Map<String, dynamic>)),
          ) ??
          const {},
    );

Map<String, dynamic> _$PlatformTargetToJson(_PlatformTarget instance) =>
    <String, dynamic>{
      'platform': instance.platform.toJson(),
      'constraints':
          instance.constraints.map((k, e) => MapEntry(k, e.toJson())),
    };
...
_Manual _$ManualFromJson(Map<String, dynamic> json) => _Manual(
      ...
      modules: (json['modules'] as List<dynamic>?)
              ?.map((e) =>
                  ManualModuleReference.fromJson(e as Map<String, dynamic>))
              .toList() ??
...
/// Filtered manuals by (case-insensitive) query against name.
final class FilteredManualsProvider extends $FunctionalProvider<
        AsyncValue<List<Manual>>, List<Manual>, FutureOr<List<Manual>>>
...
final class ManualProvider
  ...
  const ManualProvider._(
      {required ManualFamily super.from, required String super.argument})
      : super(
          retry: null,
...
final class ManualFamily extends $Family
  ...
  ManualProvider call(
    String id,
      ...
      ManualProvider._(argument: id, from: this);
