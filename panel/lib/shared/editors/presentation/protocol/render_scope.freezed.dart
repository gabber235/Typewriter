...
@override
int get hashCode => Object.hash(runtimeType,expressions,registry,budget,setBinding,executeAction,resolvePresentation,expansionStore,realmSearchSourceBuilder,const DeepCollectionEquality().hash(aliases),const DeepCollectionEquality().hash(headerShortcuts),const DeepCollectionEquality().hash(suppressedHeaders),enabled,readOnly,historyNamespace,const DeepCollectionEquality().hash(activePresentations));

@override
String toString() {
  return 'PresentationRenderScope(expressions: $expressions, registry: $registry, budget: $budget, setBinding: $setBinding, executeAction: $executeAction, resolvePresentation: $resolvePresentation, expansionStore: $expansionStore, realmSearchSourceBuilder: $realmSearchSourceBuilder, aliases: $aliases, headerShortcuts: $headerShortcuts, suppressedHeaders: $suppressedHeaders, enabled: $enabled, readOnly: $readOnly, historyNamespace: $historyNamespace, activePresentations: $activePresentations)';
}
...
/// Create a copy of PresentationRenderScope
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? expressions = null,Object? registry = null,Object? budget = null,Object? setBinding = null,Object? executeAction = null,Object? resolvePresentation = null,Object? expansionStore = null,Object? realmSearchSourceBuilder = freezed,Object? aliases = null,Object? headerShortcuts = null,Object? suppressedHeaders = null,Object? enabled = null,Object? readOnly = null,Object? historyNamespace = null,Object? activePresentations = null,}) {
  return _then(_self.copyWith(
...
as HeaderExpansionStore,realmSearchSourceBuilder: freezed == realmSearchSourceBuilder ? _self.realmSearchSourceBuilder : realmSearchSourceBuilder // ignore: cast_nullable_to_non_nullable
as RealmPresentationSearchSourceBuilder?,aliases: null == aliases ? _self.aliases : aliases // ignore: cast_nullable_to_non_nullable
...
class _PresentationRenderScope extends PresentationRenderScope {
  const _PresentationRenderScope({required this.expressions, required this.registry, required this.budget, required this.setBinding, required this.executeAction, required this.resolvePresentation, required this.expansionStore, this.realmSearchSourceBuilder, final  Map<BindingId, BindingReference> aliases = const {}, final  Map<HeaderItemCommandId, List<ShortcutActivator>> headerShortcuts = const {}, final  Set<(String, BindingReference?)> suppressedHeaders = const {}, this.enabled = true, this.readOnly = false, this.historyNamespace = "local", final  Set<PresentationId> activePresentations = const {}}): _aliases = aliases,_headerShortcuts = headerShortcuts,_suppressedHeaders = suppressedHeaders,_activePresentations = activePresentations,super._();
...
@override
int get hashCode => Object.hash(runtimeType,expressions,registry,budget,setBinding,executeAction,resolvePresentation,expansionStore,realmSearchSourceBuilder,const DeepCollectionEquality().hash(_aliases),const DeepCollectionEquality().hash(_headerShortcuts),const DeepCollectionEquality().hash(_suppressedHeaders),enabled,readOnly,historyNamespace,const DeepCollectionEquality().hash(_activePresentations));
...
as PresentationResolver,expansionStore: null == expansionStore ? _self.expansionStore : expansionStore // ignore: cast_nullable_to_non_nullable
as HeaderExpansionStore,realmSearchSourceBuilder: freezed == realmSearchSourceBuilder ? _self.realmSearchSourceBuilder : realmSearchSourceBuilder // ignore: cast_nullable_to_non_nullable
as RealmPresentationSearchSourceBuilder?,aliases: null == aliases ? _self._aliases : aliases // ignore: cast_nullable_to_non_nullable
