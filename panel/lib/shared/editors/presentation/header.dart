...
final currentHeaderActionsProvider =
    Provider.family<Map<String, HeaderActions>, EditorMode>(
...
Map<String, HeaderActions> currentHeaderActions(
  ...
  final blueprint = ref.watch(editorProvider)?.blueprint;
...
final _actionsProvider = Provider.family<HeaderActions, (String, EditorMode)>(
  (ref, argument) => _actions(ref, argument.$1, argument.$2),
  dependencies: [currentHeaderActionsProvider],
);
