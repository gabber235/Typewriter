  ...
  final definition = EntryDefinition(
    ...
    placement: EntryPlacement(
      ...
      width: context.knobs.int
          .slider(label: "Width", initialValue: 4, min: 1, max: 10),
      height: context.knobs.int
          .slider(label: "Height", initialValue: 1, min: 1, max: 10),
    ),
    data: DynamicData({
      "name": "Test Entry",
      "value": 42,
...
Widget entryNodeDeprecatedDefinitionUseCase(BuildContext context) {
  final definition = EntryDefinition(
    ...
    blueprint: EntryBlueprint(
      ...
      dataBlueprint: ObjectBlueprint(
        fields: {
          "name": DataBlueprint.string(defaultValue: "Deprecated"),
        },
      ),
      color: safeColors.randomOrNull()!,
...
Widget entryNodeReferenceUseCase(BuildContext context) {
  ...
  return FakeApp(
    child: Center(
      child: SizedBox(
        width: 5 * entryGraphCellSize,
        height: 1 * entryGraphCellSize,
        child: EntryNode(
