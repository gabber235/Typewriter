...
Widget editorTextFieldDefaultUseCase(BuildContext context) {
...
@widgetbook.UseCase(name: "Error", type: EditorTextField)
Widget editorTextFieldErrorUseCase(BuildContext context) {
  final hint = context.knobs.string(
    label: "Hint",
    initialValue: "Enter text here",
  );
...
@widgetbook.UseCase(name: "With Prefix Icon", type: EditorTextField)
Widget editorTextFieldWithPrefixIconUseCase(BuildContext context) {
  final hint = context.knobs.string(
    label: "Hint",
    initialValue: "Enter text here",
  );
...
@widgetbook.UseCase(name: "With Callbacks", type: EditorTextField)
Widget editorTextFieldWithCallbacksUseCase(BuildContext context) {
  final hint = context.knobs.string(
    label: "Hint",
    initialValue: "Enter text here",
  );
...
@widgetbook.UseCase(name: "Multiline", type: EditorTextField)
Widget editorTextFieldMultilineUseCase(BuildContext context) {
  final hint = context.knobs.string(
    label: "Hint",
    initialValue: "Enter text here",
  );
