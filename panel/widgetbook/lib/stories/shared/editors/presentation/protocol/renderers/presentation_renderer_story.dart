...
extension RendererStoryElementKind on PresentationElement {
  RendererStoryKind get rendererStoryKind => switch (this) {
    ...
    IconInputElement() => RendererStoryKind.iconInput,
    ...
    ScrollElement() => RendererStoryKind.scroll,
    CardElement() => RendererStoryKind.card,
    SectionElement() => RendererStoryKind.section,
    CollapsibleElement() => RendererStoryKind.collapsible,
