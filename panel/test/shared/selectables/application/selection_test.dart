...
final _selectionEditorSourceProvider = Provider<SelectionEditorSource>((ref) {
...
void main() {
  ...
  group("Selected provider", () {
    ...
    test("updateFieldValue calls setFieldValue on all selectables", () {
      ...
      container
          .read(_selectionEditorSourceProvider)
  ...
  group("selectedDataBlueprint provider", () {
    test("returns null when no selection", () {
      ...
      final blueprint = container.read(inspectedDataBlueprintProvider);
