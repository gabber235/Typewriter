...
void main() {
  ...
  test("When two elements with different paths are given expect there to be one inner node with no name and two inner nodes with each one leave", () {
    final node = createTreeNode([
  ...
  test("When two elements with partially same paths are given expect there to be one inner node with two inner nodes with one leave", () {
    final node = createTreeNode([
      const Pair("some.simple.path", 1),
  ...
  test("When two elements with one having a sub path of the other expect there to be one inner node with leaf and inner node with a leaf", () {
    final node = createTreeNode([
      const Pair("some.simple.path", 1),
  ...
  test("When two elements with one having a sub path after the other expect there to be one inner node with leaf and inner node with a leaf", () {
    final node = createTreeNode([
      const Pair("some.simple.path.other", 2),
      const Pair("some.simple.path", 1),
    ], (e) => e.path);
