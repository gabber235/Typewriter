...
pub struct WatchUserOrganizationsResponse_InternalError {
    ...
    pub _unrecognized: Option<
        crate::skir_client::UnrecognizedFields<WatchUserOrganizationsResponse_InternalError>,
    >,
}

impl WatchUserOrganizationsResponse_InternalError {
    pub fn default_ref() -> &'static WatchUserOrganizationsResponse_InternalError {
        static D: std::sync::LazyLock<WatchUserOrganizationsResponse_InternalError> =
            std::sync::LazyLock::new(WatchUserOrganizationsResponse_InternalError::default);
        &D
    }
}
...
impl WatchUserOrganizationsResponse_InternalError {
    ...
    pub fn serializer()
    -> crate::skir_client::Serializer<WatchUserOrganizationsResponse_InternalError> {
        initialize_module_serializers();
        crate::skir_client::internal::struct_serializer_from_static(
            WatchUserOrganizationsResponse_InternalError::_adapter(),
        )
    }
}
...
pub struct WatchUserJoinRequestsResponse_InternalError {
    /// Set this to None when you're creating a struct.
    pub _unrecognized:
        Option<crate::skir_client::UnrecognizedFields<WatchUserJoinRequestsResponse_InternalError>>,
}

impl WatchUserJoinRequestsResponse_InternalError {
    pub fn default_ref() -> &'static WatchUserJoinRequestsResponse_InternalError {
        static D: std::sync::LazyLock<WatchUserJoinRequestsResponse_InternalError> =
            std::sync::LazyLock::new(WatchUserJoinRequestsResponse_InternalError::default);
        &D
    }
}
...
impl WatchUserJoinRequestsResponse_InternalError {
    ...
    pub fn serializer()
    -> crate::skir_client::Serializer<WatchUserJoinRequestsResponse_InternalError> {
        initialize_module_serializers();
        crate::skir_client::internal::struct_serializer_from_static(
            WatchUserJoinRequestsResponse_InternalError::_adapter(),
        )
    }
}
...
pub struct SubmitUserJoinRequestResponse_InternalError {
    /// Set this to None when you're creating a struct.
    pub _unrecognized:
        Option<crate::skir_client::UnrecognizedFields<SubmitUserJoinRequestResponse_InternalError>>,
}

impl SubmitUserJoinRequestResponse_InternalError {
    pub fn default_ref() -> &'static SubmitUserJoinRequestResponse_InternalError {
        static D: std::sync::LazyLock<SubmitUserJoinRequestResponse_InternalError> =
            std::sync::LazyLock::new(SubmitUserJoinRequestResponse_InternalError::default);
        &D
    }
}
...
impl SubmitUserJoinRequestResponse_InternalError {
    ...
    pub fn serializer()
    -> crate::skir_client::Serializer<SubmitUserJoinRequestResponse_InternalError> {
        initialize_module_serializers();
        crate::skir_client::internal::struct_serializer_from_static(
            SubmitUserJoinRequestResponse_InternalError::_adapter(),
        )
    }
}
...
pub struct CancelUserJoinRequestResponse_InternalError {
    /// Set this to None when you're creating a struct.
    pub _unrecognized:
        Option<crate::skir_client::UnrecognizedFields<CancelUserJoinRequestResponse_InternalError>>,
}

impl CancelUserJoinRequestResponse_InternalError {
    pub fn default_ref() -> &'static CancelUserJoinRequestResponse_InternalError {
        static D: std::sync::LazyLock<CancelUserJoinRequestResponse_InternalError> =
            std::sync::LazyLock::new(CancelUserJoinRequestResponse_InternalError::default);
        &D
    }
}
...
impl CancelUserJoinRequestResponse_InternalError {
    ...
    pub fn serializer()
    -> crate::skir_client::Serializer<CancelUserJoinRequestResponse_InternalError> {
        initialize_module_serializers();
        crate::skir_client::internal::struct_serializer_from_static(
            CancelUserJoinRequestResponse_InternalError::_adapter(),
        )
    }
}
    ...
    static INIT: std::sync::LazyLock<()> = std::sync::LazyLock::new(|| {
        ...
        unsafe {
            let a: *mut crate::skir_client::internal::StructAdapter<
                WatchUserOrganizationsResponse_InternalError,
            > = WatchUserOrganizationsResponse_InternalError::_adapter() as *const _ as *mut _;
            (*a).finalize();
        }
        unsafe {
            ...
            (*a).add_wrapper_variant(
                ...
                crate::skir_client::Serializer::array(
                    crate::skirout::base::organization::v1::organization::Organization::serializer(
                    ),
                ),
                "",
                |v| WatchUserOrganizationsResponse::List(v),
                |x| match x {
                    WatchUserOrganizationsResponse::List(v) => v,
                    _ => unreachable!(),
                },
            );
            (*a).add_wrapper_variant(
                ...
                crate::skirout::base::organization::v1::organization::Organization::serializer(),
                "",
                |v| WatchUserOrganizationsResponse::Add(Box::new(v)),
                |x| match x {
                    WatchUserOrganizationsResponse::Add(b) => b.as_ref(),
                    _ => unreachable!(),
                },
            );
            (*a).add_wrapper_variant(
                ...
                "",
                |v| WatchUserOrganizationsResponse::Remove(Box::new(v)),
                |x| match x {
                    WatchUserOrganizationsResponse::Remove(b) => b.as_ref(),
                    _ => unreachable!(),
                },
            );
            (*a).add_wrapper_variant(
        ...
        unsafe {
            let a: *mut crate::skir_client::internal::StructAdapter<
                WatchUserJoinRequestsResponse_InternalError,
            > = WatchUserJoinRequestsResponse_InternalError::_adapter() as *const _ as *mut _;
            (*a).finalize();
        }
        unsafe {
            ...
            (*a).add_wrapper_variant(
                ...
                "",
                |v| WatchUserJoinRequestsResponse::Add(Box::new(v)),
                |x| match x {
                    WatchUserJoinRequestsResponse::Add(b) => b.as_ref(),
                    _ => unreachable!(),
                },
            );
            (*a).add_wrapper_variant(
                ...
                crate::skirout::base::kernel::v1::record_id::RecordId::serializer(),
                "",
                |v| WatchUserJoinRequestsResponse::Remove(Box::new(v)),
                |x| match x {
                    WatchUserJoinRequestsResponse::Remove(b) => b.as_ref(),
                    _ => unreachable!(),
                },
            );
            (*a).add_wrapper_variant(
        ...
        unsafe {
            let a: *mut crate::skir_client::internal::StructAdapter<
                SubmitUserJoinRequestResponse_InternalError,
            > = SubmitUserJoinRequestResponse_InternalError::_adapter() as *const _ as *mut _;
            (*a).finalize();
        }
        unsafe {
        ...
        unsafe {
            let a: *mut crate::skir_client::internal::StructAdapter<
                CancelUserJoinRequestResponse_InternalError,
            > = CancelUserJoinRequestResponse_InternalError::_adapter() as *const _ as *mut _;
            (*a).finalize();
        }
        unsafe {
