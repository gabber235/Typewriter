...
class ServerSideFlagsSpec : FunSpec({
    ...
    test("a plain player has no flags") {
        ...
        player.serverSideEntityFlags() shouldBe 0
    }
    ...
    test("sneaking and sprinting set their bits") {
        ...
        player.serverSideEntityFlags() shouldBe (EntityFlag.SNEAKING or EntityFlag.SPRINTING)
    }
    ...
    test("fire glowing and invisibility set their bits") {
        ...
        player.serverSideEntityFlags() shouldBe
    ...
    test("swimming and gliding set their bits") {
        ...
        player.serverSideEntityFlags() shouldBe (EntityFlag.SWIMMING or EntityFlag.GLIDING)
    }
    ...
    test("the flags byte keeps every bit a synthetic packet has to carry") {
        ...
        player.serverSideEntityFlags() shouldBe 0xFB
    }
})
