...
class CrossingRefusalSpec : FunSpec() {
    ...
    init {
        ...
        test("two classifications of the same crossing only fire once") {
            ...
            // The move listener and the reconcile of a moving region can both classify the same
            // player in one tick.
        ...
        // A moving region can reach a player the tick after their own crossing was refused. It
        // fires, because nothing rolls an engulf back, and the player is inside for real once it
        // has: the crossing they were refused has happened to them.
