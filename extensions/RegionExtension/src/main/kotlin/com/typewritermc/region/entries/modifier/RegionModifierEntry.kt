...
/**
 * A flag whose whole rule is one fixed allowance. It guards events that often have no player
 * behind them, like a piston pushing or a mob spawning, so there is nobody to resolve a
 * variable for.
 */
interface FixedAllowanceModifierEntry : RegionModifierEntry {
    val allowed: Boolean
}
