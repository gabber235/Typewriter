...
import com.typewritermc.region.entries.modifier.FixedAllowanceModifierEntry
...
private fun RegionModifierEntry.isAllowed(player: Player): Boolean = when (this) {
    is AllowanceModifierEntry -> allowed.get(player)
    is FixedAllowanceModifierEntry -> allowed
