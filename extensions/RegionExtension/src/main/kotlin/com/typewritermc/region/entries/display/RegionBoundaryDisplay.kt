...
abstract class RegionBoundaryDisplay(
     ...
     * mode editing and an unresolved placement call it every tick.
     */
    ...
    final override fun tick() {
        for (player in players) {
            ...
            // A placement that stops resolving takes the region away, so what was drawn for it
            // has to go too. It is drawn again once the placement resolves.
            val transform = tracker.lastTransform ?: run {
                onDisplayPlayerRemoved(player)
                continue
            }
