...
class PlayerProjectileHitEntityEventEntry(
    ...
    @LabelKey("basic.player_projectile_hit_entity_event.fields.targetTriggers.label")
    @Help(key = "basic.player_projectile_hit_entity_event.fields.targetTriggers.help")
